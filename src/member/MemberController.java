...
public class MemberController {
	...
	@RequestMapping(value="/memberInput.do", method=RequestMethod.POST)
	protected ModelAndView memberInput(HttpServletRequest arg0, 
			HttpServletResponse arg1) throws Exception {
		ModelAndView mav = new ModelAndView();
		System.out.println("10");
		MemberDTO dto = new MemberDTO();
		dto.setM_name(arg0.getParameter("m_name"));
		dto.setM_id(arg0.getParameter("m_id"));
		dto.setM_pw(arg0.getParameter("m_pw"));
		dto.setM_ssn(arg0.getParameter("m_ssn1")+"-"+arg0.getParameter("m_ssn2"));
		dto.setM_email(arg0.getParameter("m_email"));
		dto.setM_phone(arg0.getParameter("m_hp1")+"-"+arg0.getParameter("m_hp2")+"-"+
				arg0.getParameter("m_hp3"));	
		int res = memberDAO.insertMember(dto);
		if(res>0){
			arg0.setAttribute("msg","회원가입 성공하였습니다." );
			arg0.setAttribute("url","member/memberInput.jsp" );
			mav = new ModelAndView("message.jsp", "boardDTO", dto);
			return mav;
	
		}else {
			arg0.setAttribute("msg","회원가입 실패!! 회원가입 페이지로 이동합니다." );
			arg0.setAttribute("url","member/memberSsn.jsp" );
